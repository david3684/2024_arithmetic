...
finetuned_model1 = torch.load('/data2/david3684/2024_arithmetic/checkpoints/ViT-L-14/DTD/finetuned.pt')
finetuned_model2 = torch.load('/data2/david3684/2024_arithmetic/checkpoints/ViT-L-14/SUN397/finetuned.pt')
...
initial_rank_ratios = [0.5, 0.32, 0.16, 0.08]
...
for initial_rank_ratio in initial_rank_ratios:
    ...
    multitask_image_encoder = task_vector_sum.apply_to(zero_shot_encoder, scaling_coef=1.0).to(args.device)
